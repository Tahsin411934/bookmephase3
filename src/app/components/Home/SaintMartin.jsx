...
export default function SaintMartin() {
                        ...
                        {data.slice(0,12).map((property) => (
                            <SwiperSlide key={property.property_id} className="pb-2 h-auto">
                                <div className="shadow-custom flex flex-col gap-4  rounded-lg bg-white h-full transition-all duration-300 hover:shadow-lg hover:translate-y-[-4px]">
                                    ...
                                    <div className="flex flex-col w-full flex-grow pl-3 pb-5">
                                        <Link
 ...
 {/* Custom Navigation Buttons - Hidden on mobile */}
                    <button 
                        className="property-swiper-button-prev hidden sm:flex absolute left-0 md:-left-4 lg:-left-6 top-1/2 -translate-y-1/2 z-10 w-8 h-8 md:w-10 md:h-10 items-center justify-center bg-white rounded-full shadow-md hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 border border-blue-600"
                    ...
                    <button 
                        className="property-swiper-button-next hidden sm:flex absolute right-0 md:-right-4 lg:-right-6 top-1/2 -translate-y-1/2 z-10 w-8 h-8 md:w-10 md:h-10 items-center justify-center bg-white rounded-full shadow-md hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 border border-blue-600"
                    ...
                    <div className="w-full flex justify-center mt-6 md:mt-8">
                        <Link
                         ...
                         style={{
                            ...
                            href="/tour/3" // Update this with your actual route
